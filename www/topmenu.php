...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php"><img style="max-width:25px;max-height:30px;" src="images/logo1.png"></img></a>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      ?>
        <li><a class="navbar-brand" href="cart.php"><img style="max-width:25px;max-height:25px;" src="images/bucket.png" alt="Brand"></img>
